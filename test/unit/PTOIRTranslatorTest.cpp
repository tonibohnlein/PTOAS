...
bool testShiftedSlotComparisonFailsClosed() {
  ...
  Value lhs = builder.create<arith::RemUIOp>(location, body->getArgument(0), two);
  Value rhs = builder.create<arith::RemUIOp>(location, body->getArgument(0), two);
  Value raw = builder.create<arith::AddIOp>(location, body->getArgument(0), one);
