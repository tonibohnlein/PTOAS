...
defaults to **one_buffer and unchanged online_softmax**, the M1 acceptance
population. It also checks skipped/empty structured execution, deliberate
...
unsupported at this milestone. The wider control ladder and four final
milestone kernels are not yet qualified by this result.
...
constructor's default work allowance is 128 million, adjustable with
