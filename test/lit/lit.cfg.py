...
tools = [
    ...
    'pto-frontier-d1-core-test',
    'pto-frontier-d1-test',
    'pto-frontier-periodic-core-test',
    'pto-frontier-periodic-test',
    'pto-frontier-request-test',
    'pto-frontier-preparation-test',
    'pto-frontier-descriptor-core-test',
    'pto-frontier-covering-test',
    'pto-frontier-covering-core-test',
    'pto-frontier-exact-test',
    'pto-frontier-exact-core-test',
    'pto-frontier-d4-native-test',
    'pto-frontier-d4-test',
