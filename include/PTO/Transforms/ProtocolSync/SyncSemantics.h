...
struct ProtocolSyncStatistics {
    ...
    std::uint64_t rawAccessEndpointsRetained = 0;
    std::uint64_t rawAccessPairs = 0;
    std::uint64_t rawAccessPairCompletionIntrinsic = 0;
    std::uint64_t rawAccessPairCompletionPipeBarrier = 0;
    std::uint64_t rawAccessPairCompletionUnsupportedTarget = 0;
    std::uint64_t rawAccessPairCompletionUnsupportedMechanism = 0;
    std::uint64_t rawAccessPairCompletionNotApplicable = 0;
    ...
    std::uint64_t lanePatternCandidates = 0;
    std::uint64_t sharedOneShotFrontiers = 0;
    std::uint64_t sameLaneCompletionCuts = 0;
    std::uint64_t choiceBalancedRoundTrips = 0;
    std::uint64_t lanePatternTargetSupported = 0;
    std::uint64_t lanePatternTargetRejected = 0;
    std::uint64_t lanePatternCheckpointEAdmitted = 0;
    std::uint64_t lanePatternCheckpointERejected = 0;
    std::uint64_t lanePatternCheckpointENotApplicable = 0;
    std::uint64_t lanePatternLogicalCost = 0;
    std::uint64_t lanePatternSteadyStateActions = 0;
    std::uint64_t storageTrackAccessesAttempted = 0;
    std::uint64_t storageTrackAccessesProjected = 0;
    std::uint64_t storageTrackAccessesUnprojected = 0;
    std::uint64_t storageTracks = 0;
    std::uint64_t storageTrackOccurrences = 0;
    std::uint64_t storageTracksMultipleFamilies = 0;
    std::uint64_t storageTracksUncertainAlias = 0;
    std::uint64_t storageTracksMultiplePhysicalCores = 0;
    std::uint64_t storageProjectionExactAccesses = 0;
    std::uint64_t storageProjectionAccessMaskMismatches = 0;
    std::uint64_t storageProjectionPairRelations = 0;
    std::uint64_t storageProjectionOverlapPairs = 0;
    std::uint64_t storageProjectionDisjointPairs = 0;
    std::uint64_t storageProjectionOverlapPairsMissingTrack = 0;
    std::uint64_t storageProjectionDisjointPairsSharingTrack = 0;
    std::uint64_t storageProjectionReadReadOverlapPairs = 0;
    std::uint64_t storageProjectionAccumulatorReadReadOverlapPairs = 0;
    std::uint64_t storageProjectionCrossLaneReadReadOverlapPairs = 0;
    std::uint64_t storageProjectionOverlapComponents = 0;
    std::uint64_t storageProjectionMaximumAtomsPerComponent = 0;
    std::uint64_t storageProjectionMaximumAtomsPerAccess = 0;
    std::uint64_t storageTransitionFrontiers = 0;
    std::uint64_t storageLifecycleTransitions = 0;
    std::uint64_t storageCompletionTransitions = 0;
    std::uint64_t storageResidualTransitions = 0;
    std::uint64_t storageRawPairsCovered = 0;
    std::uint64_t storageRawPairsUncovered = 0;
    std::uint64_t storageTransitionTargetSupported = 0;
    std::uint64_t storageTransitionTargetRejected = 0;
    std::uint64_t storageTransitionPairMemberships = 0;
    std::uint64_t storageTransitionPairsCoveredOnce = 0;
    std::uint64_t storageTransitionPairsMultiplyCovered = 0;
    std::uint64_t storageTransitionInvalidPairMemberships = 0;
    std::uint64_t storageTransitionTrackMaskMismatches = 0;
    std::uint64_t storageTransitionLinearFrontierMemberships = 0;
    std::uint64_t storageTransitionLinearFrontierMismatches = 0;
    std::uint64_t storageTransitionFrontierMembershipsNotLinear = 0;
    std::uint64_t storageLifecycleComponentsAttempted = 0;
    std::uint64_t storageLifecyclesReconstructed = 0;
    std::uint64_t storageLifecycleEMatches = 0;
    ...
    std::uint64_t lanePatternAnalysisUs = 0;
    std::uint64_t storageTrackAnalysisUs = 0;
    ...
    std::map<std::string, std::uint64_t> lanePatternKinds;
    std::map<std::string, std::uint64_t> storageProjectionRejections;
    std::map<std::string, std::uint64_t> storageTransitionKinds;
    std::map<std::string, std::uint64_t> storageLifecycleRejections;
    std::map<std::string, std::uint64_t> storageLifecycleIndependentERejections;
};
